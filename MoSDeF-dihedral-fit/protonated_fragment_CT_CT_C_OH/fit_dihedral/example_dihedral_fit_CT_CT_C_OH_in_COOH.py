...
FF_XML_file = \
    '../src/ff_xml/oplsaa_CT_CT_C_OH_in_COOH.xml'

# The mol2 file which is used.
mol2_file = \
    '../src/starting_coords/protonated_fragment_CT_CT_C_OH_in_COOH.mol2'
...
log_files_and_removed_points = {
    '../src/guassian_runs_multiplicity_1/CT_CT_C_OH_multiplicity_1.log': [0],
}

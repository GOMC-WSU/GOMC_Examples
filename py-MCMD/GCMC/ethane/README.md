...
Hybrid NAMD/GOMC simulation of a ethane system in the Grand Canonical (GCMC) ensemble.
...
- `GCMC_ChemPot_or_Fugacity_dict`: Chemical potential or fugacity value per residue type (default: `{"ETH": -3500.0}`).

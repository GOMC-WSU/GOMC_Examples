# OPC Water GCMC Example

Hybrid MD/MC simulation of OPC water in the grand canonical ensemble with a
chemical potential of -4630 K and a temperature of 510 K.
...
Box 0 holds the OPC water system; Box 1 is the ideal-gas reservoir that supplies
and accepts molecules during the insertion and deletion moves. One cycle is one
...
(`.psf`) files for three system sizes:
- **1,000 molecules (`N_1000`)** — used by `user_input_NAMD_GOMC.json`
- **10,000 molecules (`N_10000`)**
- **100,000 molecules (`N_100000`)**

To run a different system size, change the input file paths in
`user_input_NAMD_GOMC.json`:

### 1,000 molecules (`N_1000`)
```json
"starting_pdb_box_0_file": "required_data/input/N_1000/GCMC_OPC_T510_N1000_BOX_0.pdb",
"starting_psf_box_0_file": "required_data/input/N_1000/GCMC_OPC_T510_N1000_BOX_0.psf",
"starting_pdb_box_1_file": "required_data/input/N_1000/GCMC_OPC_T510_N1000_BOX_1.pdb",
"starting_psf_box_1_file": "required_data/input/N_1000/GCMC_OPC_T510_N1000_BOX_1.psf"
```

### 10,000 molecules (`N_10000`)
```json
"starting_pdb_box_0_file": "required_data/input/N_10000/GCMC_OPC_T510_N10000_BOX_0.pdb",
"starting_psf_box_0_file": "required_data/input/N_10000/GCMC_OPC_T510_N10000_BOX_0.psf",
"starting_pdb_box_1_file": "required_data/input/N_10000/GCMC_OPC_T510_N10000_BOX_1.pdb",
"starting_psf_box_1_file": "required_data/input/N_10000/GCMC_OPC_T510_N10000_BOX_1.psf"
```

### 100,000 molecules (`N_100000`)
```json
"starting_pdb_box_0_file": "required_data/input/N_100000/GCMC_opc_N100000_box0.pdb",
"starting_psf_box_0_file": "required_data/input/N_100000/GCMC_opc_N100000_box0.psf",
"starting_pdb_box_1_file": "required_data/input/N_100000/GCMC_opc_N100000_box1.pdb",
"starting_psf_box_1_file": "required_data/input/N_100000/GCMC_opc_N100000_box1.psf"
```
...
- `simulation_temp_k`: Simulation temperature in Kelvin; this example runs at `510`.
...
- `GCMC_ChemPot_or_Fugacity_dict`: Chemical potential (K) or fugacity (bar) per residue type; this example uses `{"TIP4": -4630}`.

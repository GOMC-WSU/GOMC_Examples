...
Hybrid NAMD/GOMC simulation of liquid n-butane (TraPPE-UA) in the Isobaric-Isothermal (NPT) ensemble.
...
This example simulates a single-box liquid n-butane (TraPPE-UA) system at constant pressure (1.0 bar) and temperature (300 K):

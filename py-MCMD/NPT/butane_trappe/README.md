# n-Butane (TraPPE-UA) NPT Example

Hybrid MD/MC simulation of liquid n-butane using the TraPPE united-atom force
field in the isothermal-isobaric (NPT) ensemble at a temperature of 320 K and a
pressure of 1 bar, giving the equilibrium liquid density.
...
topology (`.psf`) files for the single box:
- Box 0: `required_data/input/butane_NPT_N1000_box0.pdb` and `.psf`
...
- **Expected liquid density**: 544.855 kg/m³ (320 K, 1 bar)

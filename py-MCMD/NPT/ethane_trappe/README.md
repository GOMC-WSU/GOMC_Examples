# Ethane (TraPPE-UA) NPT Example

Hybrid MD/MC simulation of liquid ethane using the TraPPE united-atom force field
in the isothermal-isobaric (NPT) ensemble at a temperature of 220 K and a pressure
of 5 bar, giving the equilibrium liquid density.
...
- Box 0: `required_data/input/ethane_liq.pdb` and `ethane_liq.psf`
...
- `simulation_pressure_bar`: Simulation pressure in bar; this example runs at `5.0`.
...
- **Expected liquid density**: 494.123 kg/m³ (220 K, 5 bar)

# OPC3 Water NPT Example

Hybrid MD/MC simulation of liquid OPC3 water in the isothermal-isobaric (NPT)
...
- Box 0: `required_data/input/OPC3_prod_BOX_0_restart.pdb` and `.psf`
...
- `starting_ff_file_list_gomc`: GOMC force field parameter files (`["required_data/input/OPC3_FF_GOMC.inp"]`).
- `starting_ff_file_list_namd`: NAMD force field parameter files (`["required_data/input/OPC3_FF_NAMD.inp"]`).

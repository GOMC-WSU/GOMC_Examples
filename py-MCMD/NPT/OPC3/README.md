...
Hybrid NAMD/GOMC simulation of liquid OPC3 water in the Isobaric-Isothermal (NPT) ensemble.
...
This example simulates a single-box liquid OPC3 water system at constant pressure (1.0 bar) and temperature (300 K):
...
- `starting_ff_file_list_gomc`: Force field parameter files for GOMC (`["required_data/input/OPC3_FF_GOMC.inp"]`).
- `starting_ff_file_list_namd`: Force field parameter files for NAMD (`["required_data/input/OPC3_FF_NAMD.inp"]`).

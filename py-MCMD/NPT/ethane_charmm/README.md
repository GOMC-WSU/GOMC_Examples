...
of 30 bar, giving the equilibrium liquid density.
...
- Box 0: `required_data/input/ethane_liq.pdb` and `ethane_liq.psf` (400 ethane molecules)
...
- `simulation_pressure_bar`: Simulation pressure in bar; this example runs at `30.0`.
...
- **Expected liquid density**: 513.68 kg/m³ (220 K, 30 bar)

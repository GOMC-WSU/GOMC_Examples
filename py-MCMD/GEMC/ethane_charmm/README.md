...
Hybrid NAMD/GOMC simulation of vapor-liquid phase equilibrium for ethane in the Gibbs (GEMC) ensemble.
...
This example simulates vapor-liquid phase coexistence of a ethane system using two simulation boxes:
- **Box 0**: Liquid phase.
- **Box 1**: Vapor phase.

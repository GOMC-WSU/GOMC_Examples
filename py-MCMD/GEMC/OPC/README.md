# OPC Water GEMC Example

Hybrid MD/MC simulation of OPC water in the Gibbs ensemble at a temperature of
500 K, giving the vapor and liquid densities at vapor-liquid coexistence.
...
pressure, and chemical potential, so Box 0 settles at the liquid density and
Box 1 at the vapor density along the saturation curve.
...
(`.psf`) files for three system sizes, all at 500 K:
...
```json
"starting_pdb_box_0_file": "required_data/input/N_1000/GEMC_OPC_T500_N1000_BOX_0.pdb",
"starting_psf_box_0_file": "required_data/input/N_1000/GEMC_OPC_T500_N1000_BOX_0.psf",
"starting_pdb_box_1_file": "required_data/input/N_1000/GEMC_OPC_T500_N1000_BOX_1.pdb",
"starting_psf_box_1_file": "required_data/input/N_1000/GEMC_OPC_T500_N1000_BOX_1.psf"
```

### 10,000 molecules (`N_10000`)
```json
"starting_pdb_box_0_file": "required_data/input/N_10000/GEMC_OPC_T500_N10000_BOX_0.pdb",
"starting_psf_box_0_file": "required_data/input/N_10000/GEMC_OPC_T500_N10000_BOX_0.psf",
"starting_pdb_box_1_file": "required_data/input/N_10000/GEMC_OPC_T500_N10000_BOX_1.pdb",
"starting_psf_box_1_file": "required_data/input/N_10000/GEMC_OPC_T500_N10000_BOX_1.psf"
```

### 100,000 molecules (`N_100000`)
```json
"starting_pdb_box_0_file": "required_data/input/N_100000/GEMC_opc_N100000_box0.pdb",
"starting_psf_box_0_file": "required_data/input/N_100000/GEMC_opc_N100000_box0.psf",
"starting_pdb_box_1_file": "required_data/input/N_100000/GEMC_opc_N100000_box1.pdb",
"starting_psf_box_1_file": "required_data/input/N_100000/GEMC_opc_N100000_box1.psf"
```

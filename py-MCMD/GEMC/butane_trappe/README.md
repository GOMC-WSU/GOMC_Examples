# n-Butane (TraPPE-UA) GEMC Example

Hybrid MD/MC simulation of n-butane using the TraPPE united-atom force field in
the Gibbs ensemble at a temperature of 320 K, giving the vapor and liquid
densities at vapor-liquid coexistence.
...
- Box 0 (liquid): `required_data/input/butane_GEMC_N1000_box0.pdb` and `.psf`
- Box 1 (vapor): `required_data/input/butane_GEMC_N1000_box1.pdb` and `.psf`
...
At 320 K, the coexisting densities are:
- **Expected liquid density**: 545.614 kg/m³
- **Expected gas density**: 15.433 kg/m³

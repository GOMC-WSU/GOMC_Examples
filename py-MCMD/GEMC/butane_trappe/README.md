...
Hybrid NAMD/GOMC simulation of vapor-liquid phase equilibrium for n-butane in the Gibbs (GEMC) ensemble.
...
This example simulates vapor-liquid phase coexistence of a n-butane system using two simulation boxes:
- **Box 0**: Liquid phase.
- **Box 1**: Vapor phase.
